...
unsigned int srwm_get_workspaces_underline_padding(void);
void srwm_set_workspaces_underline_padding(unsigned int);
unsigned int srwm_get_workspaces_underline_size(void);
void srwm_set_workspaces_underline_size(unsigned int);
unsigned int srwm_get_workspaces_underline_offset_from_bar_bottom(void);
void srwm_set_workspaces_underline_offset_from_bar_bottom(unsigned int);
int srwm_get_workspaces_underline_for_all_workspacess(void);
void srwm_set_workspaces_underline_for_all_workspacess(int);
...
void srwm_set_workspaces(int idx, const char* name);
void srwm_set_workspacess_len(int len);
void srwm_set_workspaces_colorful_occupied_only(int val);
void srwm_set_workspacesscheme(int idx, int scheme_idx);
