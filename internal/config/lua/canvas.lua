...
srwm.mouse.bind("Mod4", "ScrollUp", "root", function()
	srwm.canvas.zoom(1)
end)
srwm.mouse.bind("Mod4", "ScrollDown", "root", function()
	srwm.canvas.zoom(-1)
end)
srwm.mouse.bind("Mod4", "ScrollUp", "client", function()
	srwm.canvas.zoom(1)
end)
srwm.mouse.bind("Mod4", "ScrollDown", "client", function()
	srwm.canvas.zoom(-1)
end)
